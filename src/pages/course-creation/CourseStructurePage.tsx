      ...
      <div className='flex-1'>
        ...
        <div className={'bg-gray-100 px-32 py-8 text-center'}>
          <h2 className='text-2xl font-bold mb-4 '>
            У вас есть задумка курса? Составьте подробный план.
          </h2>
          <p className='mb-4'>
            Проработайте подробный план курса: это поможет студентам составить четкое
            представление о содержании курса, а вам упростит работу при создании
            видеолекций. Проработайте все детали и структуру каждой лекции: какие навыки
            вы будете отрабатывать, сколько будет длиться каждая лекция, какие
            практические задания вы хотите добавить, как вы будете вводить новый материал
            и как подводить итоги и давать краткий обзор пройденного материала.
          </p>
        </div>
