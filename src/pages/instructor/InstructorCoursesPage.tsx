  ...
  return (
    <div className='relative flex h-screen'>
      ...
      <div className='flex-1 flex flex-col items-center pl-20 md:pl-30'>
        <div className='shadow-md lg:w-8/12 h-32 flex justify-between items-center mt-20 px-10'>
          <h1 className='text-xl pr-16 lg:pr-32'>Перейти к созданию курса</h1>
          <button className='hover:bg-blue-600 text-white font-bold py-2 lg:px-20 py-4 px-10 bg-black'>
